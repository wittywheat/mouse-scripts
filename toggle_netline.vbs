...
If pcbDocObj.ActiveViewEx.DisplayControl.Option( "Option.Netlines.Enabled" ) = epcbGraphicsItemStateOnEnabled Then
	pcbDocObj.ActiveViewEx.DisplayControl.Option( "Option.Netlines.Enabled" ) = epcbGraphicsItemStateOffEnabled
Else
	pcbDocObj.ActiveViewEx.DisplayControl.Option( "Option.Netlines.Enabled" ) = epcbGraphicsItemStateOnEnabled 
End If
