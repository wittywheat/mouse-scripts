...
If pcbDocObj.ActiveViewEx.DisplayControl.Option( "Option.Planes.Data.Enabled" ) = epcbGraphicsItemStateOnEnabled Then
	pcbDocObj.ActiveViewEx.DisplayControl.Option( "Option.Planes.Data.Enabled" ) = epcbGraphicsItemStateOffEnabled
Else
	pcbDocObj.ActiveViewEx.DisplayControl.Option( "Option.Planes.Data.Enabled" ) = epcbGraphicsItemStateOnEnabled 
End If
