...
If pcbDocObj.ActiveViewEx.DisplayControl.Option( "Option.Spacers.ShadowModeEnabled" ) = epcbGraphicsItemStateOnEnabled Then
	pcbDocObj.ActiveViewEx.DisplayControl.Option( "Option.Spacers.ShadowModeEnabled" ) = epcbGraphicsItemStateOffEnabled
Else
	pcbDocObj.ActiveViewEx.DisplayControl.Option( "Option.Spacers.ShadowModeEnabled" ) = epcbGraphicsItemStateOnEnabled 
End If
